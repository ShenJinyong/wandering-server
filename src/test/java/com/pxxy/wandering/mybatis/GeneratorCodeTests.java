package com.pxxy.wandering.mybatis;
...
public class GeneratorCodeTests {
    ...
    public void generatorCode(){
        ...
        FastAutoGenerator
                // 1.配置数据源
                .create("jdbc:mysql://124.70.38.234:3306/wandering?useSSL=false&useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true","******","******")
                // 2.全局配置
